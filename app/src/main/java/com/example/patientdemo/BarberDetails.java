...
public class BarberDetails extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BarberDetailsModel model = new BarberDetailsModel(FullName, UserName, Email, MobileNo, Edu, selected_spe, Exp, Hospital, Price);

                DatabaseReference dataEntry;
                dataEntry = FirebaseDatabase.getInstance().getReference("barbers");
                ...
                Intent intent = new Intent(BarberDetails.this, VerifyOtp.class);
                intent.putExtra("UserName", UserName);
                intent.putExtra("mobile", MobileNo);
                intent.putExtra("Client", "barbers");

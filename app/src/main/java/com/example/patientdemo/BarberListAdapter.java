...
public class BarberListAdapter extends FirebaseRecyclerAdapter<BarberListModel, BarberListAdapter.drViewHolder> {

    Context context;
    public static String UserName;

    public BarberListAdapter(@NonNull FirebaseRecyclerOptions<BarberListModel> options, Context context) {
        super(options);
        this.context = context;
        BarberListAdapter.UserName = CustomerDashboard.UserName;
    }

    @Override
    protected void onBindViewHolder(@NonNull drViewHolder holder, int position, @NonNull BarberListModel docmodel) {
        ...
        holder.btn.setOnClickListener(v -> {
            ...
            intent.putExtra("dr_app_price", docmodel.getPrice());
    ...
    public drViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.design_barber_list, parent, false);

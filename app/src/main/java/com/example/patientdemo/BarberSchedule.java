...
public class BarberSchedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference("barbers").child(UserName).child("slots");
        ...
        timer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TimePickerDialog timePickerDialog = new TimePickerDialog(BarberSchedule.this,
            ...
            public void onClick(View v) {
                ...
                if(results.size() != 0) {
                    ...
                    for(String slot: results) {
                        ...
                        MainActivity.redirectActivity(BarberSchedule.this, MainActivity.class);
                        finish();
                    }
                }
                else

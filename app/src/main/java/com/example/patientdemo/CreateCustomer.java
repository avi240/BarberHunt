...
//        }
    ...
    public void registerUser(){
        ...
        CreateCustomerModel model = new CreateCustomerModel(Name, Username, Email, Mobile, Password, Age);
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                ...
                new PhoneAuthProvider.OnVerificationStateChangedCallbacks(){
                    ...
                    public void onVerificationFailed(@NonNull FirebaseException e) {
                        Toast.makeText(CreateCustomer.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onCodeSent(@NonNull String verificationId, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                        Intent intent;
                        intent = new Intent(CreateCustomer.this, VerifyOtp.class);

                        intent.putExtra("verificationId", verificationId);
                        intent.putExtra("mobile", mobileNo);
                        intent.putExtra("UserName", UserName);
                        intent.putExtra("Client", "customers");
